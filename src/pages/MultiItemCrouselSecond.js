  ...
  return (
    <div className="carousel carousal-margin">
      <ViewAll
        ...
        imageUrl={background}
        backgroundColor="linear-gradient(to bottom, #E17838 , #EB8F58)"
      />
    ...
    <div style={{ textAlign: "center" }}>
      <div className="top-section-card">
        ...
        <div onClick={handleIconClick}>
          {isFilled ? <FaHeart color="red" /> : <FaRegHeart color="red"/>}
        </div>
      </div>
...
export default MultiItemCrouselSecond;
